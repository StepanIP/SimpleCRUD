...
<c:if test="${requestScope.check == 1}">
  <div id="forms_to_update">
    <form id="form3" action="<c:url value="/reviews"/>" method="POST">
      <div class="textboxes">
        <label for="field10">user id :</label>
        <input type="text" id="field10" name="field10" value="${Review.user.id}"/><br>
        <label for="field11">product id :</label>
        <input type="text" id="field11" name="field11" value="${Review.product.id}"/><br>
        <label for="field12">text :</label>
        <input type="text" id="field12" name="field12" value="${Review.text}"/><br>
        <label for="field13">rate :</label>
        <input type="text" id="field13" name="field13" value="${Review.rate}"/><br>
      </div>
...
<div id="delete_boxes" style="display: none;">
  <form id="form1" action="<c:url value="/reviews"/>" method="POST">
...
<div id="update_box" style="display: none;">
  <form id="form2" action="<c:url value="/reviews"/>" method="POST">
...
<table>
  ...
  <c:forEach items="${allReviews}" var="review">
    <tr>
      ...
      <td><c:out value="${review.product.id}"/></td>
      <td><c:out value="${review.text}"/></td>
      <td><c:out value="${review.rate}"/></td>
    </tr>
  </c:forEach>
</table>
<br>
