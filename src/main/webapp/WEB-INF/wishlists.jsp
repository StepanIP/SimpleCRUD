...
<c:if test="${requestScope.check == 1}">
  <div id="forms_to_update">
    <form id="form3" action="<c:url value="/wishlists"/>" method="POST">
      <div class="textboxes">
        <label for="field10">product id :</label>
        <input type="text" id="field10" name="field10" value="${WishList.product.id}"/><br>
        <label for="field11">user id :</label>
        <input type="text" id="field11" name="field11" value="${WishList.user.id}"/><br>
      </div>
...
<div id="form-container" style="display: none;">
  <form id="form" action="<c:url value="/wishlists"/>" method="POST">
    <div class="textboxes">
      <label for="field1">id :</label>
      <input type="text" id="field1" name="field1"/><br>
      <label for="field2">product id :</label>
      <input type="text" id="field2" name="field2"/><br>
      <label for="field3">user id :</label>
...
<div id="delete_boxes" style="display: none;">
  <form id="form1" action="<c:url value="/wishlists"/>" method="POST">
...
<div id="update_box" style="display: none;">
  <form id="form2" action="<c:url value="/wishlists"/>" method="POST">
...
<table>
  ...
  <c:forEach items="${allWL}" var="wl">
    <tr>
      <td><c:out value="${wl.id}"/></td>
      <td><c:out value="${wl.product.id}"/></td>
      <td><c:out value="${wl.user.id}"/></td>
    </tr>
  </c:forEach>
</table>
<br>
