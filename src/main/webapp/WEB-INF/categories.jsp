...
<c:if test="${requestScope.check == 1}">
  <div id="forms_to_update">
    <form id="form3" action="<c:url value="/categories"/>" method="POST">
      <div class="textboxes">
        <label for="field10">category :</label>
        <input type="text" id="field10" name="field10" value="${Category.category}"/><br>
      </div>
...
<div id="form-container" style="display: none;">
  <form id="form" action="<c:url value="/categories"/>" method="POST">
    <div class="textboxes">
      <label for="field1">id :</label>
      <input type="text" id="field1" name="field1"/><br>
      <label for="field2">category :</label>
...
<div id="delete_boxes" style="display: none;">
  <form id="form1" action="<c:url value="/categories"/>" method="POST">
...
<div id="update_box" style="display: none;">
  <form id="form2" action="<c:url value="/categories"/>" method="POST">
