...
<c:if test="${requestScope.check == 1}">
  <div id="forms_to_update">
    <form id="form3" action="<c:url value="/carts"/>" method="POST">
      <div class="textboxes">
        <label for="field10">email :</label>
        <input type="text" id="field10" name="field10" value="${Cart.totalCost}"/><br>
        <label for="field11">phoneNumber :</label>
        <input type="text" id="field11" name="field11" value="${Cart.totalAmount}"/><br>
      </div>
...
<div id="form-container" style="display: none;">
  <form id="form" action="<c:url value="/carts"/>" method="POST">
    <div class="textboxes">
      <label for="field1">id :</label>
      <input type="text" id="field1" name="field1"/><br>
      <label for="field2">totalCost :</label>
      <input type="text" id="field2" name="field2"/><br>
      <label for="field3">totalAmount :</label>
...
<div id="delete_boxes" style="display: none;">
  <form id="form1" action="<c:url value="/carts"/>" method="POST">
...
<div id="update_box" style="display: none;">
  <form id="form2" action="<c:url value="/carts"/>" method="POST">
...
<table>
  ...
  <c:forEach items="${allCarts}" var="carts">
    <tr>
      <td><c:out value="${carts.id}"/></td>
      <td><c:out value="${carts.totalCost}"/></td>
      <td><c:out value="${carts.totalAmount}"/></td>
    </tr>
  </c:forEach>
</table>
</body>
