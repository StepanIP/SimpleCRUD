...
<body>
<h1>Список додаткової інформації користувачів:</h1>
<div class="buttons">
...
<c:if test="${requestScope.check == 1}">
    <div id="forms_to_update">
        <form id="form3" action="<c:url value="/detail_informations"/>" method="POST">
            <div class="textboxes">
                <label for="field10">age :</label>
                <input type="text" id="field10" name="field10" value="${DT.age}"/><br>
                <label for="field11">country :</label>
                <input type="text" id="field11" name="field11" value="${DT.country}"/><br>
                <label for="field12">deliveryAddress :</label>
                <input type="text" id="field12" name="field12" value="${DT.deliveryAddress}"/><br>
                <label for="field13">cart_id :</label>
                <input type="text" id="field13" name="field13" value="${DT.cart.id}"/><br>
            </div>
...
<div id="form-container" style="display: none;">
    <form id="form" action="<c:url value="/detail_informations"/>" method="POST">
        <div class="textboxes">
            ...
            <label for="field4">deliveryAddress :</label>
            <input type="text" id="field4" name="field4"/><br>
            <label for="field5">cart_id :</label>
...
<div id="delete_boxes" style="display: none;">
    <form id="form1" action="<c:url value="/detail_informations"/>" method="POST">
...
<div id="update_box" style="display: none;">
    <form id="form2" action="<c:url value="/detail_informations"/>" method="POST">
...
<table>
    ...
    <c:forEach items="${allDT}" var="di">
        <tr>
            <td><c:out value="${di.id}"/></td>
            <td><c:out value="${di.age}"/></td>
            <td><c:out value="${di.country}"/></td>
            <td><c:out value="${di.deliveryAddress}"/></td>
            <td><c:out value="${di.cart.id}"/></td>
        </tr>
    </c:forEach>
</table>
</body>
